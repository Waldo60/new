...
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Woli1 ❌\033[1;33m ]"
msg -bar
echo -e "\033[97m"
echo -e "  \033[41m    -- INSTALACION DE PAQUETES PARA VPS-MX --    \e[49m"
echo -e "  \033[100m     PONER ATENCION  PARA NEXT PREGUNTA     "
echo -e "\033[97m"
msg -bar
...
clear
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Woli2 ❌\033[1;33m ]"
msg -bar2
echo ""
...
clear
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Woli3 ❌\033[1;33m ]"
msg -bar2
echo ""
...
clear
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Woli4 ❌\033[1;33m ]"
msg -bar2
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/ArchivosUtilitarios/nombre.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name IDT.log|grep -w "IDT.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/IDT.log https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/ArchivosUtilitarios/IDT.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name tiemlim.log|grep -w "tiemlim.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/tiemlim.log https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/ArchivosUtilitarios/tiemlim.log &>/dev/null

wget -O /bin/rebootnb https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/ArchivosUtilitarios/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/ArchivosUtilitarios/resetsshdrop &> /dev/null
...
echo 'clear' >> .bashrc
echo 'echo ""' >> .bashrc
echo 'echo -e "\t\033[91m __     ______  ____        __  __  ___  _    _" '>> .bashrc
echo 'echo -e "\t\033[91m \ \   / /  _ \/ ___|      | |  | |  -  | |  | |" '>> .bashrc
echo 'echo -e "\t\033[91m  \ \ / /| |_) \___ \ _____| |/\| | | | | |  | |" '>> .bashrc
echo 'echo -e "\t\033[91m   \ V / |  __/ ___) |_____|  /\  | |-| | |__| |" '>> .bashrc
echo 'echo -e "\t\033[91m    \_/  |_|   |____/      |_/  \_| ___ | ___|_|" '>> .bashrc
echo 'echo "" '>> .bashrc
...
echo -e "  \033[1;41m                menu o vps-mx             \033[0;37m" && msg -bar2
sleep 5
exit
}
ofus () {
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/ArchivosUtilitarios/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/ArchivosUtilitarios/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/Monitor-Service/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/Monitor-Service/estilos.css &> /dev/null
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Woli6 ❌\033[1;33m ]"
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "Code de KEY Invalido!") ]]; then
   msg -bar2
   msg -verd "$(source trans -b es:${id} " Ficheros Copiados"|sed -e 's/[^a-z -]//ig'): \e[97m[\e[93mVPS-MX #Mod by @Woli0101\e[97m]"
   ...
   wget -O $HOME/systemverify https://raw.githubusercontent.com/Waldo60/Edit.full/main/Install/systemverify &> /dev/null
